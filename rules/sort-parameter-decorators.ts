...
type MESSAGE_ID =
  | 'unexpectedParameterDecoratorsGroupOrder'
  | 'unexpectedParameterDecoratorsOrder'

export default createEslintRule<Options<string[]>, MESSAGE_ID>({
  name: 'sort-parameter-decorators',
  meta: {
    type: 'suggestion',
    docs: {
      description: 'Enforce sorted parameter decorators.',
    },
    fixable: 'code',
    schema: [
      {
        ...
        properties: {
          type: {
            description: 'Specifies the sorting parameter.',
            type: 'string',
