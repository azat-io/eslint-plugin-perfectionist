...
type MESSAGE_ID =
  ...
  | 'missedSpacingBetweenInterfaces'
  | 'extraSpacingBetweenInterfaces'
            ...
            pairwise(nodes, (left, right) => {
              ...
              messageIds = [
                ...
                ...getNewlinesErrors({
                  ...
                  rightNum,
                  sourceCode,
                  missedSpacingError: 'missedSpacingBetweenInterfaces',
                  extraSpacingError: 'extraSpacingBetweenInterfaces',
                  options,
                }),
              ]
