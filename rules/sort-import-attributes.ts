...
type MessageId =
  | 'missedSpacingBetweenImportAttributes'
  | 'unexpectedImportAttributesGroupOrder'
  | 'extraSpacingBetweenImportAttributes'
  | 'unexpectedImportAttributesOrder'
...
export default createEslintRule<Options, MessageId>({
  ...
  meta: {
    ...
    messages: {
      missedSpacingBetweenImportAttributes: MISSED_SPACING_ERROR,
      extraSpacingBetweenImportAttributes: EXTRA_SPACING_ERROR,
      unexpectedImportAttributesGroupOrder: GROUP_ORDER_ERROR,
      unexpectedImportAttributesOrder: ORDER_ERROR,
    },
    docs: {
