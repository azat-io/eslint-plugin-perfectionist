...
describe('sort-export-attributes', () => {
  ...
  describe('alphabetical', () => {
    ...
    it('sorts import attributes', async () => {
      ...
      await invalid({
        ...
        `,
        code: dedent`
          export { data } from 'module' with { a: 'a', c: 'c', b: 'b' }
        `,
        options: [options],
      })
    })
    ...
    it('handles string-literal attribute keys', async () => {
      await valid({
        code: dedent`
          export { data } from 'module' with { 'a': '1', 'b': '2' }
        `,
        options: [options],
      })
      ...
      await invalid({
        ...
        `,
        code: dedent`
          export { data } from 'module' with { 'b': '2', 'a': '1' }
        `,
        options: [options],
      })
    })
  ...
  describe('natural', () => {
    ...
    it('sorts attributes in natural order', async () => {
      await valid({
        code: dedent`
          export { data } from 'module' with { link1: 'v', link2: 'v', link10: 'v' }
        `,
        options: [options],
      })
      ...
      await invalid({
        ...
        `,
        code: dedent`
          export { data } from 'module' with { link1: 'v', link10: 'v', link2: 'v' }
        `,
        options: [options],
      })
    })
  ...
  describe('line-length', () => {
    ...
    it('sorts import attributes', async () => {
      await valid({
        code: dedent`
          export { data } from 'module' with { ccc: 'v', bb: 'v', a: 'v' }
        `,
        options: [options],
      })
      ...
      await invalid({
        ...
        `,
        code: dedent`
          export { data } from 'module' with { a: 'v', ccc: 'v', bb: 'v' }
        `,
        options: [options],
      })
    })
    ...
    it('handles string-literal attribute keys', async () => {
      await valid({
        code: dedent`
          export { data } from 'module' with { 'bb': 'v', 'a': 'v' }
        `,
        options: [options],
      })
      ...
      await invalid({
        ...
        `,
        code: dedent`
          export { data } from 'module' with { 'a': 'v', 'bb': 'v' }
        `,
        options: [options],
      })
    })
  ...
  describe('unsorted', () => {
    ...
    it('allows any order when type is unsorted', async () => {
      await valid({
        code: dedent`
          export { data } from 'module' with { b: 'b', c: 'c', a: 'a' }
        `,
        options: [options],
      })
    })
  ...
  describe('misc', () => {
    ...
    it('ignores exports without attributes', async () => {
      await valid(
        dedent`
    ...
    it('ignores exports with a single attribute', async () => {
      await valid(
        dedent`
          export { data } from 'module' with { a: 'a' }
        `,
      )
    })
      ...
      await invalid({
        output: dedent`
          export { data } from 'module' with {
            b: 'b',
            c: 'c',
            // eslint-disable-next-line rule-to-test/sort-export-attributes
            a: 'a',
          }
        `,
        code: dedent`
      ...
      await invalid({
        output: dedent`
          export { data } from 'module' with {
            b: 'b',
            c: 'c',
            a: 'a', // eslint-disable-line rule-to-test/sort-export-attributes
          }
        `,
        code: dedent`
          export { data } from 'module' with {
      ...
      await invalid({
        output: dedent`
          export { data } from 'module' with {
            a: 'a',
            d: 'd',
            /* eslint-disable rule-to-test/sort-export-attributes */
            c: 'c',
            b: 'b',
            // Shouldn't move
            /* eslint-enable */
