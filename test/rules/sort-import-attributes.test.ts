      ...
      it.each([
        ...
        async rgbAllNamesMatchPattern => {
          await invalid({
            ...
            output: dedent`
              import data from 'module' with { r: 'r', g: 'g', b: 'b' }
            `,
            code: dedent`
              import data from 'module' with { b: 'b', g: 'g', r: 'r' }
            `,
          })
        },
      )
    ...
    describe('useConfigurationIf.matchesAstSelector', () => {
      it('skips config when selector does not match the sorted node type', async () => {
        await invalid({
          ...
          output: dedent`
            import data from 'module' with { a: 'a', b: 'b' }
          `,
          code: dedent`
            import data from 'module' with { b: 'b', a: 'a' }
          `,
        })
      })
          ...
          options: [
            {
              ...options,
              useConfigurationIf: {
                matchesAstSelector: 'ImportDeclaration[source.value="module"]',
              },
              type: 'unsorted',
            },
          ],
          ...
          options: [
            {
              ...
              useConfigurationIf: {
                matchesAstSelector:
                  'ImportDeclaration[source.value="other-module"]',
