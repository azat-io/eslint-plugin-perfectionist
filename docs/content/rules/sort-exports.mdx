...
Specifies how to handles newlines after the last export statement.

- `'ignore'` — Do not report errors related to newlines.
- `0` — No newlines are allowed after the last export statement.
- Any other number — Enforce this number of newlines after the last export statement.
