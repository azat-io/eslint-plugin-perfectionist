...
```ts
{
  'perfectionist/sort-class-constructors': [
    'error',
    {
      useConfigurationIf: {
...
- [Rule source](https://github.com/azat-io/eslint-plugin-perfectionist/blob/main/rules/sort-class-constructors.ts)
- [Test source](https://github.com/azat-io/eslint-plugin-perfectionist/blob/main/test/rules/sort-class-constructors.test.ts)
