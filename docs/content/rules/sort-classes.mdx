...
#### Methods
- Selectors: `constructor`, `get-method`, `set-method`, `method`.
- Modifiers: `abstract`, `decorated`, `override`, `protected`, `private`, `public`, `static`.
...
#### Properties
- Selectors: `property`.
- Modifiers: `abstract`, `decorated`, `override`, `readonly`, `protected`, `private`, `public`, `static`.
...
- Elements with their name starting with `_`.
...
##### The `unknown` group
Members that don’t fit into any other group can be matched with the `unknown` group.
