...
Allows you to use comments to separate the members of enums into logical groups. This can help in organizing and maintaining large sets by creating partitions within the enum based on comments.
