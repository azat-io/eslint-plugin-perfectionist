...
Specifies how to handles newlines after the last import statement.

- `'ignore'` — Do not report errors related to newlines.
- `0` — No newlines are allowed after the last import statement.
- Any other number — Enforce this number of newlines after the last import statement.
