...
shortDescription: Installation and basic configuration guide
...
- `tsconfig` — `tsconfig` configuration option used by rules such as [`sort-imports`](/rules/sort-imports#tsconfig) or [`sort-modules`](/rules/sort-modules#tsconfig).
