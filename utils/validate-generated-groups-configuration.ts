...
import { validateNewlinesBetweenAndCommentAboveInsideGroups } from './validate-newlines-between-and-comment-above-inside-groups'
...
export let validateGeneratedGroupsConfiguration = ({
  ...
  validateNewlinesBetweenAndCommentAboveInsideGroups(options)
}
